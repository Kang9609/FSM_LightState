...
set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { o_lightState }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
...
set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { i_reset }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND
